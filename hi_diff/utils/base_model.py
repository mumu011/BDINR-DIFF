...
from hi_diff.utils import lr_scheduler as lr_scheduler
...
class BaseModel(nn.Module):
    ...
    def model_to_device(self, net):
        ...
        if self.opt['dist']:
            ...
            # self.device = torch.device(f'cuda:{net.device_ids[0]}')
    ...
    def setup_schedulers(self):
        ...
        if scheduler_type in ['MultiStepLR', 'MultiStepRestartLR']:
            ...
            for optimizer in self.optimizers:
                self.schedulers.append(CosineAnnealingLR(optimizer, **train_opt['scheduler']['args']))
        else:
